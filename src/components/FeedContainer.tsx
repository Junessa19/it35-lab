...
import {
  ...
  IonCardSubtitle, IonCardTitle, IonAlert, IonText, IonAvatar, IonCol, IonGrid,
...
const FeedContainer = () => {
  ...
  return (
    <>
      <IonContent className="feed-container">
        {user ? (
          <>
            <IonCard className="create-post-card">
              <IonCardHeader>
                <IonCardTitle className="ion-title-custom">Create Post</IonCardTitle>
              </IonCardHeader>
              <IonCardContent>
                <IonInput
                  value={postContent}
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', padding: '0.5rem' }}>
                <IonButton className="ion-button-custom" onClick={createPost}>Post</IonButton>
              </div>
            </IonCard>

            {posts.map(post => (
              <IonCard key={post.post_id} className="post-card" style={{ marginTop: '2rem' }}>
                <IonCardHeader>
                  <IonRow>
                    <IonCol size="1.85">
                      <IonAvatar>
